...
.innerHTML = `You 
<img src="JavaScript Icons/${playerMove}-emoji.png" class="rock-paper-scissors-icon">
<img src="JavaScript Icons/${computerMove}-emoji.png" class="rock-paper-scissors-icon">
Computer`;
